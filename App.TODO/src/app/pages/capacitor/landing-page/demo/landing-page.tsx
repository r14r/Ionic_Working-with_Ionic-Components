...
export class LandingPage {
    @State() selectedCodeTab = 'notifications';
                        ...
                        <Grid>
                            <Col md={6} sm={6} xs={6} cols={12}>
                                <hgroup class="hero__heading">
                                    ...
                                    <Heading level={1}>
                                        A cross-platform native runtime for web
                                        apps.
                                    </Heading>
                                    <Heading level={3}>
                                        Capacitor enables web developers to
                                        build iOS, Android, and Progressive Web
                                        Apps with web technologies in a single
                                        code base.
                                    </Heading>
                    ...
                    <section class="section--web-apps-to-native">
                        ...
                        <Grid>
                            <Col md={4} sm={4} xs={12} cols={12}>
                                ...
                                <Paragraph>
                                    Build web-based applications that run
                                    equally well across iOS, Android, and as
                            ...
                            <Col md={4} sm={4} xs={12} cols={12}>
                                ...
                                <Paragraph>
                                    Access the full Native SDKs on each
                                    platform, and easily deploy to the App
                                    Stores (and the web).
                                </Paragraph>
                            </Col>
                            <Col md={4} sm={4} xs={12} cols={12}>
                                ...
                                <Paragraph>
                                    Add custom native functionality with a
                                    simple Plugin API, or use existing Cordova
                                    plugins with our compatibility layer.
                                </Paragraph>
                            </Col>
                        </Grid>
                    </section>
                    ...
                    <section class="section--your-framework">
                        <hgroup>
                            ...
                            <Paragraph>
                                ...
                                project, framework or library. Convert an
                                existing React, Angular, Svelte, Vue, Ember (or
                                your preferred Web Framework) project to native
                                mobile and use any UI library of your choosing.
                            </Paragraph>
                        </hgroup>
                        <Grid>
                            {[
...
`}
            ...
            <Grid class="section--getting-started__step">
                ...
                <Col md={5} sm={5} xs={5} cols={12}>
                    <Heading level={3}>
                        Access APIs on both native and web, or extend with your
                        own.
                    </Heading>
                </Col>
                <Col md={6} sm={6} xs={6} cols={12}>
                    <Tabs>
                        <TabBar>
                            <TabBarButton
                                ...
                                tabSelect={() =>
                                    setSelectedCodeTab('notifications')
                                }
                            >
                                Notifications
                            </TabBarButton>
                            <TabBarButton
                                ...
                                tabSelect={() =>
                                    setSelectedCodeTab('geolocation')
                                }
                            >
                                Geolocation
                            </TabBarButton>
    ...
    <section class="whitepaperCta">
        <ResponsiveContainer>
            ...
            <div class="whitepaperCta__content">
                <Heading>
                    See when and why to use Capacitor to build cross-platform
                    apps.&nbsp;
