          ...
          `}
            ...
            <Grid class="section--getting-started__step">
                ...
                <Col md={5} sm={5} xs={5} cols={12}>
                    ...
                    <Paragraph>
                        Create the Capacitor app using the Cordova app's name
                        and id found in `config.xml`.
                    </Paragraph>
                </Col>
                <Col md={6} sm={6} xs={6} cols={12}>
                    <code-snippet
...
`}
            ...
            <Grid class="section--getting-started__step">
                ...
                <Col md={5} sm={5} xs={5} cols={12}>
                    ...
                    <Paragraph>
                        The compiled web assets will be copied into each
                        Capacitor native platform during the next step.
                    </Paragraph>
                </Col>
                <Col md={6} sm={6} xs={6} cols={12}>
                    <code-snippet
...
`}
            ...
            <Grid class="section--getting-started__step">
                ...
                <Col md={5} sm={5} xs={5} cols={12}>
                    ...
                    />
                    <Paragraph>
                        Capacitor native projects exist in their own top-level
                        folders and should be considered part of your app (check
                        them into source control). Any existing Cordova plugins
                        are automatically installed into each native project. 🎉
                    </Paragraph>
                </Col>
                <Col md={6} sm={6} xs={6} cols={12}>
                    <code-snippet
...
`}
            ...
            <Grid class="section--getting-started__step">
                ...
                <Col md={5} sm={5} xs={5} cols={12}>
                    ...
                    <Paragraph>
                        Reuse the existing splash screen/icon images, located in
                        the top-level `resources` folder of your Cordova
                        project, using the `cordova-res` tool. Images are copied
            ...
            <Grid class="section--getting-started__step">
                ...
                <Col md={5} sm={5} xs={5} cols={12}>
                    ...
                    <Paragraph>
                        ...
                        plugins. You may be able to switch to the
                        Capacitor-equivalent Cordova plugin, such as the Camera.
                    </Paragraph>
                    <Paragraph>
                        Remove unneeded ones to improve performance and reduce
                        app size.
                    </Paragraph>
                </Col>
                <Col md={6} sm={6} xs={6} cols={12}>
...
`}
            ...
            <Grid class="section--getting-started__step">
                ...
                <Col md={5} sm={5} xs={5} cols={12}>
                    ...
                    <Paragraph>
                        After successful migration testing, Cordova can be
            ...
            <Grid class="section--getting-started__step">
                ...
                <Col md={5} sm={5} xs={5} cols={12}>
                    ...
                    <Paragraph>
                        ...
                        <a
                            href="/docs/cordova/using-cordova-plugins"
                            target="_blank"
                        >
                        ...
                        , or create your own{' '}
                        <a href="/docs/plugins" target="_blank">
                            native plugin
                        </a>
                        .
                    </Paragraph>
    ...
    <ResponsiveContainer class="section--more-resources">
        ...
        <more-resources
            resources={[
                ...
                {
                    uid:
                        'thanks-to-capacitor-ive-fallen-in-love-with-mobile-again',
                    type: 'blog',
                },
