...
import {
    handleRoutableLinkClick,
    getTemplateFromPath,
    getSiteStructureList,
} from '../../utils/route-link';
        ...
        return (
            <div class="container">
                ...
                <div class="content-container">
                    ...
                    <app-marked
                        fetchPath={this.item.filePath}
                        renderer={(docsContent) => [
                            <Helmet>
                                <title>
                                    {docsContent.title
                                        ? `${docsContent.title} - Capacitor`
                                        : 'Capacitor'}
                                </title>
                                {docsContent.description && (
                                    <meta
                                        name="description"
                                        content={`${docsContent.description} - Official Capacitor Documentation`}
                                    />
                                )}
                            </Helmet>,
                            <div class="doc-content">
                                <div class="measure-lg">
                                    <div
                                        ...
                                        innerHTML={docsContent.content}
                                    ></div>
                                    <h2>Contributors</h2>
                                    <contributor-list
                                        contributors={docsContent.contributors}
                                    ></contributor-list>
                                    <lower-content-nav
                                        next={this.nextItem}
                                        prev={this.prevItem}
