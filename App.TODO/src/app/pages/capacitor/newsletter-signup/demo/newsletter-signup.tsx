...
export class NewsletterSignup {
    ...
    @State() emailInvalidfalse;
    @State() emailSuccessfalse;

    sendToHubspot = async (e: UIEvent) => {
        e.preventDefault();
        const url: string =
            'https://api.hsforms.com/submissions/v3/integration/submit/3776657/c8d355e3-a5ad-4f91-a2c0-c9dc93e10658';
                ...
                <ResponsiveContainer>
                    <hgroup>
                        <div>
                            ...
                            <p>
                                Keep up to date with all the latest Capacitor
                                news and updates
                            </p>
                        </div>
                    </hgroup>
                    ...
                    {this.emailSuccess && (
                        <div class="success__message">
                            ...
                            >
                                ...
                                />
                                <path
                                    d="M13.87 20.97a1.75 1.75 0 00-2.54 2.408l2.54-2.407zm3.588 6.33l-1.27 1.204a1.75 1.75 0 002.54 0l-1.27-1.204zM30.67 15.904a1.75 1.75 0 00-2.54-2.408l2.54 2.408zm-19.34 7.474l4.858 5.126 2.54-2.408-4.858-5.125-2.54 2.407zm7.398 5.126l11.942-12.6-2.54-2.408-11.942 12.6 2.54 2.408z"
                                    fill="#43C465"
                                />
                            </svg>
                            <p>
                                Success! You will now receive our email
                                newsletter.
                            </p>
                        </div>
                    )}
